			...
			steps: [
				...
				},
				{
					...
					popover: {
						...
						description: 'Tabel kunci yang menampilkan <b>capaian aktual setiap CPL</b> untuk angkatan yang dipilih. Setiap baris CPL menampilkan CPMK-CPMK kontributor beserta nilai per kolom:<br><br><b>① Rata-rata CPMK</b> — rata-rata sederhana nilai CPMK seluruh mahasiswa: <code>Σ nilai CPMK ÷ jumlah mahasiswa angkatan terkait</code> pada <b>mata kuliah kontributor</b>. Bobot dalam tanda kurung adalah total bobot CPMK dari <b>mata kuliah kontributor</b>.<br><br><b>② CPL (Total Bobot)</b> — penjumlahan seluruh <code>nilai CPMK</code> dari semua mahasiswa pada angkatan dan mata kuliah kontributor terkait, dengan total bobot semua CPMK kontributor dalam tanda kurung.<br><br><b>③ Rata-rata Capaian CPL (%)</b> — rata-rata persentase capaian CPL per angkatan per tahun akademik: <code>(Σ Capaian CPL Mahasiswa) ÷ (Total Mahasiswa)</code>. Ditampilkan <span style="color:#198754">hijau</span> jika ≥ standar minimal, <span style="color:#dc3545">merah</span> jika tidak tercapai. Perhitungan ini sesuai dengan CPL angkatan per tahun akademik',
						side: 'top'
					}
				},
				{
