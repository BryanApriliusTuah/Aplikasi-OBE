		...
		<div class="sidebar">
			<ul class="nav flex-column">
				...
				<?php if (session('role') === 'admin'): ?>
					<li class="nav-item">
						<a class="nav-link<?= uri_string() == 'admin/user' ? ' active' : '' ?>" href="<?= base_url('admin/user') ?>"
				...
				<li class="nav-item">
					<a class="nav-link<?= uri_string() == 'admin/dosen' ? ' active' : '' ?>" href="<?= base_url('admin/dosen') ?>"
				...
				<li class="nav-item">
					<a class="nav-link<?= uri_string() == 'admin/mengajar' ? ' active' : '' ?>" href="<?= base_url('admin/mengajar') ?>"
						data-bs-toggle="tooltip" data-bs-placement="right" title="Lihat riwayat aktivitas pengguna dalam sistem">
						<i class="bi bi-journal-text"></i> Mengajar
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link<?= uri_string() == 'admin/nilai' ? ' active' : '' ?>" href="<?= base_url('admin/nilai') ?>"
						data-bs-toggle="tooltip" data-bs-placement="right" title="Lihat riwayat aktivitas pengguna dalam sistem">
