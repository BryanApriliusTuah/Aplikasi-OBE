...
<h2 class="fw-bold mb-4">Edit Konfigurasi Nilai</h2>
...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <form action="<?= base_url('admin/settings/update/' . $grade['id']) ?>" method="post">
            <?= csrf_field() ?>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               id="grade_letter"
                               name="grade_letter"
                               value="<?= old('grade_letter', $grade['grade_letter']) ?>"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number"
                               ...
                               id="order_number"
                               name="order_number"
                               value="<?= old('order_number', $grade['order_number']) ?>"
                               placeholder="1"
                               required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input"
                                   ...
                                   id="is_passing_yes"
                                   value="1"
                                   <?= old('is_passing', $grade['is_passing']) == '1' ? 'checked' : '' ?>>
                        ...
                        <div class="form-check">
                            <input class="form-check-input"
                                   ...
                                   id="is_passing_no"
                                   value="0"
                                   <?= old('is_passing', $grade['is_passing']) == '0' ? 'checked' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input"
                                   ...
                                   id="is_active_yes"
                                   value="1"
                                   <?= old('is_active', $grade['is_active']) == '1' ? 'checked' : '' ?>>
                        ...
                        <div class="form-check">
                            <input class="form-check-input"
                                   ...
                                   id="is_active_no"
                                   value="0"
                                   <?= old('is_active', $grade['is_active']) == '0' ? 'checked' : '' ?>>
