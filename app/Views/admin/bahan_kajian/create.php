...
<div class="container py-3">
    <div class="card p-4">
        <h3 class="fw-bold mb-3">Tambah Bahan Kajian</h3>

        <form action="<?= base_url('admin/bahan-kajian/store') ?>" method="post" autocomplete="off">
            <?= csrf_field() ?>
            ...
            <div class="d-flex gap-2">
                <a href="<?= base_url('admin/bahan-kajian') ?>" class="btn btn-outline-secondary btn-lg w-100">
                    ← Kembali
                </a>
