...
<div class="card border-0 shadow-sm">
	<div class="card-body p-4">
		...
		<div class="d-flex justify-content-between align-items-center mb-4">
			...
			<a href="<?= base_url('admin/tahun-akademik/create') ?>" class="btn btn-dark btn-sm">
							...
							<tr>
								...
								<td class="text-center">
									<div class="d-flex gap-2 justify-content-center">
										<a href="<?= base_url('admin/tahun-akademik/edit/' . $row['id']) ?>"
											class="btn btn-sm btn-light border-0"
											data-bs-toggle="tooltip" title="Edit"
											style="width:32px;height:32px;padding:0;display:inline-flex;align-items:center;justify-content:center;">
											<i class="bi bi-pencil"></i>
										</a>
										<a href="<?= base_url('admin/tahun-akademik/toggle/' . $row['id']) ?>"
											class="btn btn-sm btn-light border-0"
											data-bs-toggle="tooltip" title="<?= $row['is_active'] ? 'Nonaktifkan' : 'Aktifkan' ?>"
											style="width:32px;height:32px;padding:0;display:inline-flex;align-items:center;justify-content:center;">
											<i class="bi bi-toggle-<?= $row['is_active'] ? 'on' : 'off' ?>"></i>
										</a>
										<a href="<?= base_url('admin/tahun-akademik/delete/' . $row['id']) ?>"
