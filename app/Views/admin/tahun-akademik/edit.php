...
<div class="card border-0 shadow-sm">
	<div class="card-body p-4">
		...
		<div class="d-flex justify-content-between align-items-center mb-4">
			...
			<a href="<?= base_url('admin/tahun-akademik') ?>" class="btn btn-outline-secondary btn-sm">
		...
		<form action="<?= base_url('admin/tahun-akademik/update/' . $tahun_akademik['id']) ?>" method="post">
			<?= csrf_field() ?>
			...
			<div class="d-flex gap-2 mt-5">
				...
				<a href="<?= base_url('admin/tahun-akademik') ?>" class="btn btn-outline-secondary">Batal</a>
			</div>
		</form>
	</div>
</div>
