...
<div id="emptyState" class="card" style="display: none;">
	<div class="card-body text-center py-5 text-muted">
		...
		<small>Pilih filter semester dan/atau tahun akademik untuk melihat laporan CPL</small>
	</div>
</div>
...
<div id="dataTable" style="display: none;">
	<div class="card">
		<div class="card-header bg-secondary text-white">
			<h5 class="mb-0"><i class="bi bi-table"></i> Laporan Rata-rata CPL per Mata Kuliah</h5>
		</div>
		<div class="card-body">
