...
class AuthFilter implements FilterInterface
{
	public function before(RequestInterface $request, $arguments = null)
	{
		...
		// If accessing mahasiswa routes, must be mahasiswa
		if ($arguments && in_array('mahasiswa', $arguments)) {
			if ($session->get('role') !== 'mahasiswa') {
				return redirect()->to('/rps')->with('error', 'Hanya mahasiswa yang bisa akses halaman ini.');
			}
		}
	}
